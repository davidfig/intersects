...
exports.boxCircleOutline = boxCircleOutline;

var _circlePoint = require("./circle-point");

var _boxCircle = require("./box-circle");
 ...
 */
function circleOutlineBox(xc, yc, rc, x, y, width, height, thickness) {
  thickness = thickness || 1;
  var count = 0;
  count += (0, _circlePoint.circlePoint)(xc, yc, rc, x, y) ? 1 : 0;
  count += (0, _circlePoint.circlePoint)(xc, yc, rc, x + width, y) ? 1 : 0;
  count += (0, _circlePoint.circlePoint)(xc, yc, rc, x, y + height) ? 1 : 0;
  count += (0, _circlePoint.circlePoint)(xc, yc, rc, x + width, y + height) ? 1 : 0; // if no corners are inside the circle, then intersects only if box encloses circle-outline

  if (count === 0) {
    return (0, _boxCircle.boxCircle)(x, y, width, height, xc, yc, rc);
  ...
  if (count === 4) {
    return !(0, _circlePoint.circlePoint)(xc, yc, rc - thickness, x, y) || !(0, _circlePoint.circlePoint)(xc, yc, rc - thickness, x + width, y) || !(0, _circlePoint.circlePoint)(xc, yc, rc - thickness, x, y + height) || !(0, _circlePoint.circlePoint)(xc, yc, rc - thickness, x + width, y + height);
  }
}
/**
 * circleOutline-box (axis-aligned) collision
...
function boxCircleOutline(x, y, width, height, xc, yc, rc, thickness) {
  return circleOutlineBox(xc, yc, rc, x, y, width, height, thickness);
}

},{"./box-circle":2,"./circle-point":12}],4:[function(require,module,exports){
"use strict";
...
var _ellipseLine = require("./ellipse-line");

var _boxPoint = require("./box-point");
...
function ellipseBox(xe, ye, rex, rey, xb, yb, wb, hb) {
  return (0, _boxPoint.boxPoint)(xb, yb, wb, hb, xe, ye) || (0, _ellipseLine.ellipseLine)(xe, ye, rex, rey, xb, yb, xb + wb, yb) || (0, _ellipseLine.ellipseLine)(xe, ye, rex, rey, xb, yb + hb, xb + wb, yb + hb) || (0, _ellipseLine.ellipseLine)(xe, ye, rex, rey, xb, yb, xb, yb + hb) || (0, _ellipseLine.ellipseLine)(xe, ye, rex, rey, xb + wb, yb, xb + wb, yb + hb);
}
/**
...
},{"./box-point":6,"./ellipse-line":18}],5:[function(require,module,exports){
"use strict";
...
function lineBox(x1, y1, x2, y2, xb, yb, wb, hb) {
  if ((0, _boxPoint.boxPoint)(xb, yb, wb, hb, x1, y1) || (0, _boxPoint.boxPoint)(xb, yb, wb, hb, x2, y2)) {
    return true;
  }

  return (0, _lineLine.lineLine)(x1, y1, x2, y2, xb, yb, xb + wb, yb) || (0, _lineLine.lineLine)(x1, y1, x2, y2, xb + wb, yb, xb + wb, yb + hb) || (0, _lineLine.lineLine)(x1, y1, x2, y2, xb, yb + hb, xb + wb, yb + hb) || (0, _lineLine.lineLine)(x1, y1, x2, y2, xb, yb, xb, yb + hb);
}
/**
 * box-line collision
 * @param {number} xb top-left corner of box
...
},{"./box-point":6,"./line-line":21}],6:[function(require,module,exports){
"use strict";
...
var _polygonPolygon = require("./polygon-polygon");
...
function polygonBox(points, x, y, w, h) {
  ...
  return (0, _polygonPolygon.polygonPolygon)(points, points2);
}
/**
...
},{"./polygon-polygon":27}],8:[function(require,module,exports){
"use strict";
...
exports.circleOutlineCircle = circleOutlineCircle;
exports.circleCircleOutline = circleCircleOutline;

var _circlePoint = require("./circle-point");

function circleOutlineCircle(xc, yc, rc, xco, yco, rco, thickness) {
  if ((0, _circlePoint.circlePoint)(xc, yc, rc, xco, yco)) {
    return true;
  }
}

function circleCircleOutline(xco, yco, rco, xc, yc, rc) {
  return circleOutlineCircle(xc, yc, rc, xco, yco, rco);
}

},{"./circle-point":12}],10:[function(require,module,exports){
"use strict";
...
var ellipseHelper = _interopRequireWildcard(require("./ellipse-helper"));
...
},{"./ellipse-helper":17}],11:[function(require,module,exports){
"use strict";
...
var _polygonPoint = require("./polygon-point");

var _circleLine = require("./circle-line");
 ...
 */
function polygonCircle(points, xc, yc, rc, tolerance) {
  if ((0, _polygonPoint.polygonPoint)(points, xc, yc, tolerance)) {
    return true;
  }
  ...
  for (var i = 0; i < count - 2; i += 2) {
    if ((0, _circleLine.lineCircle)(points[i], points[i + 1], points[i + 2], points[i + 3], xc, yc, rc)) {
      return true;
    }
  }

  return (0, _circleLine.lineCircle)(points[0], points[1], points[count - 2], points[count - 1], xc, yc, rc);
}
/**
...
function circlePolygon(xc, yc, rc, points, tolerance) {
  return polygonCircle(points, xc, yc, rc, tolerance);
}

},{"./circle-line":11,"./polygon-point":26}],14:[function(require,module,exports){
"use strict";
...
exports.lineCircleOutline = lineCircleOutline;
 ...
 * @param {number} thickness of circle outline
 */
function circleOutlineLine(xc, yc, rc, x1, y1, x2, y2, thickness) {
  thickness = thickness || 1;
  return (0, _circleCircle.lineCircle)(x1, y1, x2, y2, xc, yc, rc) && !((0, _circlePoint.circlePoint)(xc, yc, rc - thickness, x1, y1) && (0, _circlePoint.circlePoint)(xc, yc, rc - thickness, x2, y2));
}
/**
...
function lineCircleOutline(x1, y1, x2, y2, xc, yc, rc, thickness) {
  return circleOutlineLine(xc, yc, rc, x1, y1, x2, y2, thickness);
}

},{"./circle-circle":8,"./circle-point":12}],15:[function(require,module,exports){
"use strict";
 ...
 * @param {number} thickness of circle outline
 */
function circleOutlinePoint(xc, yc, rc, x, y, thickness) {
  thickness = thickness || 1;
  return (0, _circlePoint.circlePoint)(xc, yc, rc, x, y) && !(0, _circlePoint.circlePoint)(xc, yc, rc - thickness, x, y);
}
/**
...
},{"./circle-point":12}],16:[function(require,module,exports){
"use strict";
...
},{"./ellipse-helper":17}],17:[function(require,module,exports){
"use strict";
...
function polygonEllipse(points, xe, ye, rex, rey) {
  if ((0, _polygonPoint.polygonPoint)(points, xe, ye)) {
    return true;
  }
  ...
  for (var i = 0; i < count - 2; i += 2) {
    if ((0, _ellipseLine.lineEllipse)(points[i], points[i + 1], points[i + 2], points[i + 3], xe, ye, rex, rey)) {
      return true;
    }
  }

  return (0, _ellipseLine.lineEllipse)(points[0], points[1], points[count - 2], points[count - 1], xe, ye, rex, rey);
}
/**
...
},{"./ellipse-line":18,"./polygon-point":26}],21:[function(require,module,exports){
"use strict";
...
var _lineToPolygon = require("./lineToPolygon");

var _polygonPolygon = require("./polygon-polygon");

var _linePolygon = require("./line-polygon");

var _lineToLine = require("./lineToLine");
...
function lineLine(x1, y1, x2, y2, x3, y3, x4, y4, thickness1, thickness2) {
  if (thickness1 || thickness2) {
    ...
    return (0, _lineToLine.lineToLine)(x1, y1, x2, y2, x3, y3, x4, y4);
  }
}

function lineLineThickness(x1, y1, x2, y2, x3, y3, x4, y4, thickness1, thickness2) {
  if (thickness1 && thickness2) {
    return (0, _polygonPolygon.polygonPolygon)((0, _lineToPolygon.lineToPolygon)(x1, y1, x2, y2, thickness1), (0, _lineToPolygon.lineToPolygon)(x3, y3, x4, y4, thickness2));
  } else if (thickness1) {
    return (0, _linePolygon.linePolygon)(x3, y3, x4, y4, (0, _lineToPolygon.lineToPolygon)(x1, y1, x2, y2, thickness1));
  } else if (thickness2) {
    return (0, _linePolygon.linePolygon)(x1, y1, x2, y2, (0, _lineToPolygon.lineToPolygon)(x3, y3, x4, y4, thickness1));
  }
}

},{"./line-polygon":23,"./lineToLine":24,"./lineToPolygon":25,"./polygon-polygon":27}],22:[function(require,module,exports){
"use strict";
...
function linePolygon(x1, y1, x2, y2, points, tolerance) {
  var length = points.length; // check if first point is inside the shape (this covers if the line is completely enclosed by the shape)

  if ((0, _polygonPoint.polygonPoint)(points, x1, y1, tolerance)) {
    return true;
  ...
  for (var i = 0; i < length; i += 2) {
    ...
    if ((0, _lineToLine.lineLine)(x1, y1, x2, y2, points[i], points[i + 1], points[j], points[j + 1])) {
      return true;
    }
  }
...
},{"./lineToLine":24,"./polygon-point":26}],24:[function(require,module,exports){
"use strict";
...
var _linePoint = require("./line-point");
...
function polygonPoint(points, x, y, tolerance) {
  ...
  for (i = 0; i < length; i += 2) {
    ...
    if ((0, _linePoint.linePoint)(p1x, p1y, p2x, p2y, x, y, tolerance)) {
      return true;
    }
  }
...
},{"./line-point":22}],27:[function(require,module,exports){
"use strict";
...
Object.defineProperty(exports, "boxBox", {
  enumerable: true,
  get: function get() {
    return _boxBox.boxBox;
  }
});
Object.defineProperty(exports, "boxCircle", {
  enumerable: true,
  get: function get() {
    return _boxCircle.boxCircle;
  }
});
Object.defineProperty(exports, "circleBox", {
  enumerable: true,
  get: function get() {
    return _boxCircle.circleBox;
  }
});
Object.defineProperty(exports, "boxCircleOutline", {
  enumerable: true,
  get: function get() {
    return _boxCircleOutline.boxCircleOutline;
  }
});
Object.defineProperty(exports, "circleOutlineBox", {
  enumerable: true,
  get: function get() {
    return _boxCircleOutline.circleOutlineBox;
  }
});
Object.defineProperty(exports, "boxEllipse", {
  enumerable: true,
  get: function get() {
    return _boxEllipse.boxEllipse;
  }
});
Object.defineProperty(exports, "ellipseBox", {
  enumerable: true,
  get: function get() {
    return _boxEllipse.ellipseBox;
  }
});
Object.defineProperty(exports, "boxLine", {
  enumerable: true,
  get: function get() {
    return _boxLine.boxLine;
  }
});
Object.defineProperty(exports, "lineBox", {
  enumerable: true,
  get: function get() {
    return _boxLine.lineBox;
  }
});
Object.defineProperty(exports, "boxPolygon", {
  enumerable: true,
  get: function get() {
    return _boxPolygon.boxPolygon;
  }
});
Object.defineProperty(exports, "polygonBox", {
  enumerable: true,
  get: function get() {
    return _boxPolygon.polygonBox;
  }
});
Object.defineProperty(exports, "boxPoint", {
  enumerable: true,
  get: function get() {
    return _boxPoint.boxPoint;
  }
});
Object.defineProperty(exports, "pointBox", {
  enumerable: true,
  get: function get() {
    return _boxPoint.pointBox;
  }
});
Object.defineProperty(exports, "circleCircle", {
  enumerable: true,
  get: function get() {
    return _circleCircle.circleCircle;
  }
});
Object.defineProperty(exports, "circleCircleOutline", {
  enumerable: true,
  get: function get() {
    return _circleCircleOutline.circleCircleOutline;
  }
});
Object.defineProperty(exports, "circleOutlineCircle", {
  enumerable: true,
  get: function get() {
    return _circleCircleOutline.circleOutlineCircle;
  }
});
Object.defineProperty(exports, "circleEllipse", {
  enumerable: true,
  get: function get() {
    return _circleEllipse.circleEllipse;
  }
});
Object.defineProperty(exports, "ellipseCircle", {
  enumerable: true,
  get: function get() {
    return _circleEllipse.ellipseCircle;
  }
});
Object.defineProperty(exports, "circleLine", {
  enumerable: true,
  get: function get() {
    return _circleLine.circleLine;
  }
});
Object.defineProperty(exports, "lineCircle", {
  enumerable: true,
  get: function get() {
    return _circleLine.lineCircle;
  }
});
Object.defineProperty(exports, "circlePolygon", {
  enumerable: true,
  get: function get() {
    return _circlePolygon.circlePolygon;
  }
});
Object.defineProperty(exports, "polygonCircle", {
  enumerable: true,
  get: function get() {
    return _circlePolygon.polygonCircle;
  }
});
Object.defineProperty(exports, "circlePoint", {
  enumerable: true,
  get: function get() {
    return _circlePoint.circlePoint;
  }
});
Object.defineProperty(exports, "pointCircle", {
  enumerable: true,
  get: function get() {
    return _circlePoint.pointCircle;
  }
});
Object.defineProperty(exports, "circleOutlineLine", {
  enumerable: true,
  get: function get() {
    return _circleOutlineLine.circleOutlineLine;
  }
});
Object.defineProperty(exports, "lineCircleOutline", {
  enumerable: true,
  get: function get() {
    return _circleOutlineLine.lineCircleOutline;
  }
});
Object.defineProperty(exports, "circleOutlinePoint", {
  enumerable: true,
  get: function get() {
    return _circleOutlinePoint.circleOutlinePoint;
  }
});
Object.defineProperty(exports, "pointCircleOutline", {
  enumerable: true,
  get: function get() {
    return _circleOutlinePoint.pointCircleOutline;
  }
});
Object.defineProperty(exports, "ellipseEllipse", {
  enumerable: true,
  get: function get() {
    return _ellipseEllipse.ellipseEllipse;
  }
});
Object.defineProperty(exports, "ellipseLine", {
  enumerable: true,
  get: function get() {
    return _ellipseLine.ellipseLine;
  }
});
Object.defineProperty(exports, "lineEllipse", {
  enumerable: true,
  get: function get() {
    return _ellipseLine.lineEllipse;
  }
});
Object.defineProperty(exports, "ellipsePolygon", {
  enumerable: true,
  get: function get() {
    return _ellipsePolygon.ellipsePolygon;
  }
});
Object.defineProperty(exports, "polygonEllipse", {
  enumerable: true,
  get: function get() {
    return _ellipsePolygon.polygonEllipse;
  }
});
Object.defineProperty(exports, "ellipsePoint", {
  enumerable: true,
  get: function get() {
    return _ellipsePoint.ellipsePoint;
  }
});
Object.defineProperty(exports, "pointEllipse", {
  enumerable: true,
  get: function get() {
    return _ellipsePoint.pointEllipse;
  }
});
Object.defineProperty(exports, "lineLine", {
  enumerable: true,
  get: function get() {
    return _lineLine.lineLine;
  }
});
Object.defineProperty(exports, "linePolygon", {
  enumerable: true,
  get: function get() {
    return _linePolygon.linePolygon;
  }
});
Object.defineProperty(exports, "polygonLine", {
  enumerable: true,
  get: function get() {
    return _linePolygon.polygonLine;
  }
});
Object.defineProperty(exports, "linePoint", {
  enumerable: true,
  get: function get() {
    return _linePoint.linePoint;
  }
});
Object.defineProperty(exports, "pointLine", {
  enumerable: true,
  get: function get() {
    return _linePoint.pointLine;
  }
});
Object.defineProperty(exports, "polygonPolygon", {
  enumerable: true,
  get: function get() {
    return _polygonPolygon.polygonPolygon;
  }
});
Object.defineProperty(exports, "polygonPoint", {
  enumerable: true,
  get: function get() {
    return _polygonPoint.polygonPoint;
  }
});
Object.defineProperty(exports, "pointPolygon", {
  enumerable: true,
  get: function get() {
    return _polygonPoint.pointPolygon;
  }
});

var _boxBox = require("./box-box");

var _boxCircle = require("./box-circle");

var _boxCircleOutline = require("./box-circleOutline");

var _boxEllipse = require("./box-ellipse");

var _boxLine = require("./box-line");

var _boxPolygon = require("./box-polygon");

var _boxPoint = require("./box-point");

var _circleCircle = require("./circle-circle");

var _circleCircleOutline = require("./circle-circleOutline");

var _circleEllipse = require("./circle-ellipse");

var _circleLine = require("./circle-line");

var _circlePolygon = require("./circle-polygon");

var _circlePoint = require("./circle-point");

var _circleOutlineLine = require("./circleOutline-line");

var _circleOutlinePoint = require("./circleOutline-point");

var _ellipseEllipse = require("./ellipse-ellipse");

var _ellipseLine = require("./ellipse-line");

var _ellipsePolygon = require("./ellipse-polygon");

var _ellipsePoint = require("./ellipse-point");
...
},{"./box-box":1,"./box-circle":2,"./box-circleOutline":3,"./box-ellipse":4,"./box-line":5,"./box-point":6,"./box-polygon":7,"./circle-circle":8,"./circle-circleOutline":9,"./circle-ellipse":10,"./circle-line":11,"./circle-point":12,"./circle-polygon":13,"./circleOutline-line":14,"./circleOutline-point":15,"./ellipse-ellipse":16,"./ellipse-line":18,"./ellipse-point":19,"./ellipse-polygon":20,"./line-line":21,"./line-point":22,"./line-polygon":23,"./polygon-point":26,"./polygon-polygon":27}],29:[function(require,module,exports){
"use strict";
